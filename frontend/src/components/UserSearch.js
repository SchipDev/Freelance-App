    ...
    window.emailjs
      .send(
        ...
        templateId,
        {
          ...
          number: this.props.currUser.phoneNum,
      ...
      return (
        <div key={i} id="showUser" className="eachJob">
          ...
          >
            ...
            >
              <button>R</button>
              {this.props.currUser.connections.includes(user._id) ? (
                <button style={{ backgroundColor: "limegreen" }}>C</button>
              ) : (
                ""
              )}
            </div>
          ...
          {!this.props.currUser.connections.includes(user._id) ? (
            <ConnectButton
              currUserId={this.props.currUser._id}
              utcId={user._id}
